package com.antzuhl.chat.config;

import com.antzuhl.chat.common.FlushDiskType;
...
public class MessageStoreConfig {
    ...
    private String storePathCommitLog = System.getProperty("user.home") + File.separator + "store"
            + File.separator + "messagelog";

    // CommitLog file size,default is 10M
    private int mapedFileSizeCommitLog = 1024 * 1024 * 10;

    public static final int CQ_STORE_UNIT_SIZE = 20;
    // ConsumeQueue file size,default is 30W
    private int mapedFileSizeConsumeQueue = 300000 * CQ_STORE_UNIT_SIZE;
    ...
    public int getMapedFileSizeConsumeQueue() {
        int factor = (int) Math.ceil(this.mapedFileSizeConsumeQueue / (CQ_STORE_UNIT_SIZE * 1.0));
        return (int) (factor * CQ_STORE_UNIT_SIZE);
    }
